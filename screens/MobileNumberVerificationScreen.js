...
function BranchPicker({ selectedValue, onValueChange }) {
            ...
            >
              <View style={loginStyles.verificationCard}>
                ...
                <View style={loginStyles.branchPickerContainer}>
                  ...
                  {Platform.OS === 'ios' ? (
                    <BranchPicker selectedValue={branch} onValueChange={setBranch} />
                  ) : (
                    <View style={[loginStyles.pickerWrapper, { backgroundColor: mainButtonColor }]}>
                      <Picker
